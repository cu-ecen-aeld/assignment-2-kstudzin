...
void test_validate_my_username()
{
	...
	const char* username_from_conf_file;
	username_from_conf_file = malloc_username_from_conf_file();

	TEST_ASSERT_EQUAL_STRING_MESSAGE(username_from_conf_file, username, "Username is incorrect");
}
